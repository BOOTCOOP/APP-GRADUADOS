<template>
        ...
        <div v-else-if="aviso" class="aviso-detail">
          ...
          <div class="contact-section">
            ...
            <div class="contact-item">
              ...
              <button class="contact-action" @click="callPhone(aviso.contact_phone)">
            ...
            <div class="contact-item">
              ...
              <button class="contact-action" @click="sendEmail(aviso.contact_email)">
  ...
  async function cancelAviso() {
    const alert = await alertController.create({
      header: 'Confirmar',
      message: '¿Estás seguro de que deseas cancelar este aviso? Esta acción no se puede deshacer.',
      buttons: [
        {
          text: 'Cancelar',
          role: 'cancel'
        },
        {
          ...
          handler: async () => {
            ...
            try {
              const success = await store.dispatch('avisos/cancelAviso', aviso.value.id)
              if (success) {
