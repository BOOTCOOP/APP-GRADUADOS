        ...
        <ion-card-content class="job-card-content">
            ...
            <div class="job-info-row">
                <div class="job-info-item">
                    <ion-icon :md="locationOutline" :ios="locationOutline" color="primary"></ion-icon>
                    <ion-text color="dark">
                ...
                <div class="job-info-item">
                    <ion-icon 
                        :md="job.modality === 'Presencial' ? businessOutline : 
                             job.modality === 'Híbrido' ? desktopOutline : 
                             homeOutline" 
                        :ios="job.modality === 'Presencial' ? businessOutline : 
                             job.modality === 'Híbrido' ? desktopOutline : 
                             homeOutline" 
                        :color="job.modality === 'Presencial' ? 'success' : 
                               job.modality === 'Híbrido' ? 'warning' : 
                               'secondary'"
                    ></ion-icon>
                    <ion-text 
                        :color="job.modality === 'Presencial' ? 'success' : 
                               ...
                               'secondary'"
                    >
                        <small><strong>{{ job.modality }}</strong></small>
                    </ion-text>
                </div>
            </div>
            ...
            <div class="job-footer">
                ...
                >
                    Ver más
                    <ion-icon :md="arrowForwardOutline" :ios="arrowForwardOutline" slot="end"></ion-icon>
                </ion-button>
            </div>
...
import { IonCard, IonCardContent, IonIcon, IonText, IonButton, useIonRouter } from '@ionic/vue';
