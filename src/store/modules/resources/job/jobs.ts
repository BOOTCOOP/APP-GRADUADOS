...
export default {
  ...
  actions: {
     ...
     * Los datos salen del perfil del usuario logueado (no se envía body): el
     * backend identifica a la persona por el Bearer token.
     *
     * Recibe el id pelado, no un objeto: `dispatch('jobs/apply', job.id)`.
     */
    apply(ctx, id) {
      return new Promise((resolve, reject) => {
        axios
